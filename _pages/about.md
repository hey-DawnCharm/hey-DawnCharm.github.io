...
- *2021.12-2022.07*，**广西产业技术研究院**（人工智能与大数据应用研究所有限公司）—— 见习生<br>**主要工作**：负责业务场景编辑，参与数字孪生、虚拟现实、智慧城市、元宇宙多人协作平台等项目的研发<br>**项目经历**：<br>（1）参与广西交通职业技术学院数字孪生平台研发，具体工作：倾斜摄影数据处理（包括数据采集、数据渲染及模型优化）、网络信息安全中心场景编辑（包括机房模型建模、灯光渲染、材质编辑）<br>（2）参与DTI²数字孪生低代码开发平台研发，具体工作：场景编辑（包括模板场景模型建模、场景数据优化、及视觉特效开发），视频制作（包括脚本编辑、介绍视频的剪辑制作、音乐录制等）<br>（3）参与元宇宙多人协作平台研发，具体工作：场景编辑（包括三大场景礼堂、小型会议室、党建馆的场景模型建模，场景数据优化）、灯光渲染（包括场景灯光搭建、灯光烘培、光影数据优化）、人物制作（包括人物模型编辑、人物动作设计与编辑）。<br><br>
...
（6）*2020年* 负责梧州学院马克思主义学院全国高校讲思政课公开课录制与制作<br>
（7）<br>
（8）<br>
（9）<br>
