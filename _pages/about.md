...
- *2018.09 - 2022.06*<br> **梧州学院**（数字媒体技术专业） —— 工学学士<br>主修课程：人机交互设计、平面设计、影视剪辑及后期特效、三维建模技术、二/三维动画设计、计算机图形学、web应用开发技术  等<br><br>**毕业课题**：《城市三维影像的增强现实可视化技术研究——以梧州学院为例》<br>**主要内容**：基于无人机倾斜摄影技术构建实景三维模型，通过单体化处理、水面修复、道路置平等手段优化模型质量，采用定格帧叠加过渡场技术实现实景航拍、三维模型与动态信息（热力图、粒子特效）的融合，形成全空间一体化展示体系。结合激光描边与粒子系统增强表现力，输出多终端适配的增强现实宣传影片，为智慧城市可视化提供了参考。 
...
- *2021.12-2022.07*，**广西产业技术研究院**（人工智能与大数据应用研究所有限公司）—— 见习生<br>**主要工作**：负责业务场景编辑，参与数字孪生、虚拟现实、智慧城市、元宇宙多人协作平台等项目的研发<br>**参与项目**：
